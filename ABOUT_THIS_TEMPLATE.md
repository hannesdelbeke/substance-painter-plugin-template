...
├── substance_painter_plugin_template             # The main python package for the project
...
e.g: `cat substance_painter_plugin_template/VERSION` will get the project version without harming
